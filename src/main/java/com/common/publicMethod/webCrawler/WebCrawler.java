...
public abstract class WebCrawler {
	...
	public HttpEntity getHtmlPage(String urlPath) throws ClientProtocolException, IOException{
		...
		CloseableHttpResponse response = (CloseableHttpResponse) httpClient.execute(get,httpContext);
